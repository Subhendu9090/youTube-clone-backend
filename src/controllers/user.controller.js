...
const registerUser = asyncHandeler(async (req, res) => {
    ...
    if (!avatar) {
        throw new ApiError(408, "Avtar file is required")
    }
...
const loginUser = asyncHandeler(async (req, res) => {
    ...
    const options = {   // for passing cookies
        httpOnly: true,
        secure: true
    }
...
const refreshAccessToken = asyncHandeler(async (req, res) => {
    ...
    try {
        ...
        throw new ApiError(409, error?.messege || "Invalid refresh Token")
    }
})
...
const updateAcountDetails = asyncHandeler(async (req, res) => {
